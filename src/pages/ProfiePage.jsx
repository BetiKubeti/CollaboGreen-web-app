                                ...
                                <div className='contacts-list'>
                                    ...
                                    {contactLinkedIn && (
                                        <div className='linked-in contact'>
                                            ...
                                            <a href={contactLinkedIn} target='_blank'>{companyName} LinkedIn Page</a>
                                        </div>
                                    )}
                                    {contactFacebook && (
                                        <div className='facebook contact'>
                                            ...
                                            <a href={contactFacebook} target='_blank'>{companyName} Facebook Page</a>
                                        </div>
                                    )}
                                    {contactInstagram && (
                                        <div className='instagram contact'>
                                            ...
                                            <a href={contactInstagram} target='_blank'>{companyName} Instagram Page</a>
                                        </div>
                                    )}
                                </div>
