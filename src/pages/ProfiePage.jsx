...
import MailImageSidebar from '../assets/Mail-Image-Sidebar.png';
import PhoneImageSidebar from '../assets/Phone-Image-Sidebar.png';
                            ...
                            <div className='add-contact-information-sidebar'>
                                ...
                                <div className='contacts-list'>
                                    <div className='email contact'>
                                        <img src={MailImageSidebar} alt="image for mail" />{email}
                                    </div>
                                    <div className='phone contact'>
                                        <img src={PhoneImageSidebar} alt="image for phone" />
                                    </div>
